// src/components/TextCustomizer.tsx
import React from 'react';
import '../fonts.css'; // Ensure custom fonts like OpenDyslexic are loaded here
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <select
          id="fontFamily"
          value={fontFamily} // Use the current fontFamily value
